...
import com.origamisoftware.teach.advanced.services.DatabaseActivitiesService;
...
public class DatabaseUtils {
     ...
     * @throws DatabaseConnectionException if accessing and executing the sql failed in an unexpected way.
     *
     */
    public static boolean executeSQL(String someSQL) throws DatabaseConnectionException {
        Connection connection = null;
